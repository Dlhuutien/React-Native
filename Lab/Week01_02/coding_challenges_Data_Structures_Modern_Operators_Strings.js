...
const players1Final = fieldPlayers1.concat(['Thiago', 'Coutinho', 'Perisic'])
...
function printGoals(...players) {
    let totalGoals = players.length;
    for (let i = 0; i < players.length; i++) {
      console.log(players[i] + ' scored ' + totalGoals + ' goals');
    }
  }
printGoals("Neuer","Burki")
